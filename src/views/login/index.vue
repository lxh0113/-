  ...
  <div class="loginBack">
    ...
    <div class="center">
      <div class="loginBox">
        <h3>欢迎登录智会通</h3>
        <h6>WELCOME</h6>
        <el-form size="large" style="max-width: 360px; margin: 40px auto">
          <el-form-item>
            <el-input
              :prefix-icon="User"
              style="height: 50px;"
          ...
          <el-form-item style="display: flex;margin-bottom: 60px;">
            <el-checkbox-group style="flex:1;text-align: left;">
              <el-checkbox> 记住密码 </el-checkbox>
            </el-checkbox-group>
            <p>没有账号，<span @click="$router.push('/register')" style="color: #3578F6;font-weight: bold;cursor: pointer;">去注册</span></p>
          </el-form-item>
          <el-form-item>
            <el-button style="width: 360px;height:50px" type="primary">登录</el-button>
          </el-form-item>
        </el-form>
      </div>
